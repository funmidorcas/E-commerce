    ...
    <div className='' key={market.id}>
      <img className='w-full rounded-2xl' src={market.image} alt="" />
         ...
         <p className=''>{market.others}</p>
          <div className=' bg-amber-200 lg:w-[60%] w-[40%] justify-self-center rounded-2xl third-section-btn'>
          <button onClick={()=>detail(market.id)} className='text-sm'> Select options</button>
          </div>
  </div>
    ))}
  </div>
...
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 w-full px-4">  
    ...
    <div className='' key={newarrival.id}>
      <img className='w-full rounded-2xl' src={newarrival.image} alt="" />
         ...
         <div className='lg:w-[60%] bg-amber-200 w-[40%]  justify-self-center rounded-2xl  third-section-btn'>
          <button onClick={()=>newDetail(newarrival.id)}
           className='text-sm'> Select options</button>
         </div>
  </div>
    ))}
  </div>
...
<h1 style={{marginBottom: "40px"}}>nosso Instagram</h1>
 <div className='grid grid-cols-2 lg:grid-cols-4 gap-2 lg:gap-4'>
  ...
  <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQcpmVpH9cpE9jas__TcQ1ESp4VPo-jfD4gvQ&s" alt="" />
  <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQcpmVpH9cpE9jas__TcQ1ESp4VPo-jfD4gvQ&s" alt="" />
  <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQcpmVpH9cpE9jas__TcQ1ESp4VPo-jfD4gvQ&s" alt="" />
 </div>
</motion.section>
...
<motion.section initial={{opacity: 0, y: 100}}
 ...
 <form action="" onSubmit={submit}
  ...
  <button className='button bg-amber-900 rounded-3xl'>Submit</button>
 </form>
</motion.section>
